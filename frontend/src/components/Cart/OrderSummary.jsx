  ...
  const CoupanModel = (
    <Model closeModel={showCloseModel}>
      <div
        ...
        className="bg-[var(--primarycolor)] text-[var(--primarytext)] p-4 rounded-lg"
      >
        ...
        <div className="shadow-md p-2 ">
          <div className="flex gap-2">
            <input
              ...
              id="check1"
              checked={coupan1}
              onChange={() => setCoupan1((prev) => !prev)}
            />
            <label htmlFor="check1">Seasonal Offer</label>
          </div>

          <p>
            Get a refrsh discount of ₹50 on your orders! Brighten up your
            shopping.
          </p>
        </div>
        ...
        <button
          onClick={closeModel}
          className="px-4 py-2 bg-black text-white w-full rounded-lg"
        >
          Apply
        </button>
      </div>
  ...
  return (
    <>
      <div className="flex flex-col gap-4 px-4 py-2  bg-[var(--primarycolor)] max-w-[360px] w-full">
        ...
        <button
          className="px-4 py-2 bg-[var(--app-border)] text-[var(--neutral)] "
          onClick={() => navigate(`/checkout/${coupan1}/${coupan2}`)}
        >
          Checkout
        </button>
      </div>
