...
const testimonials = [
  {
    text: "The food is always fresh, delicious, and delivered on time. Ordering has never been this convenient.",
    image:
  ...
  {
    text: "I love how easy it is to discover new dishes. The variety and quality of the food are excellent.",
    image:
  ...
  {
    text: "Fast delivery, great packaging, and amazing taste. This has become my go-to food ordering platform.",
    image:
  ...
  {
    text: "The ordering experience is simple and smooth. I can find everything from quick snacks to complete meals.",
    image:
  ...
  {
    text: "The meals arrive fresh and well packaged every time. The quality is consistent, which keeps me coming back.",
    image:
  ...
  {
    text: "From browsing the menu to checkout, everything feels effortless. The food quality is even better.",
    image:
  ...
  {
    text: "There are so many options to choose from, and the recommendations make discovering new food really easy.",
    image:
  ...
  {
    text: "The delivery is reliable and the food arrives exactly as expected. It has made ordering meals much easier.",
    image:
  ...
  {
    text: "Great selection, simple checkout, and consistently tasty meals. I regularly order lunch and dinner from here.",
    image:
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16">
          ...
          <p className="text-center mt-5 text-neutral-500 dark:text-neutral-400 text-lg leading-relaxed max-w-sm transition-colors">
            Discover why food lovers choose us for fresh meals, quick
            delivery, and a simple ordering experience.
          </p>
        </div>
